...
Team members: Andrew Bruneel(Image Space), Arya Sun(D3 Visualization), Bongjun Kim(Solr or ElasticSEarch), Jiayin Wang(D3 Visualization), Jingyi Wang(D3 Visualization), Tongxin Ye(MEMEX Geoparser)
